    ...
    <main>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
              <div className="relative h-48">
                <Image
                  src="/images/smart-classrooms/1.jpg"
                  alt="Smart Classes"
                  fill
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 italic">
                "SNBP's International School has provided my child with an excellent learning environment. The teachers
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 italic">
                "The holistic approach to education at SNBP's has helped my daughter develop not just academically, but
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 italic">
                ...
                gained confidence since joining SNBP's International School."
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-accent text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Join SNBP's INTERNATIONAL School?</h2>
