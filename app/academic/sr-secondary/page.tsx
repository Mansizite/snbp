          ...
          <div className="lg:col-span-2 space-y-8 fade-in">
            <div className="bg-white p-10 rounded-lg shadow-md">
              ...
              >
                {/* Centered Image */}
                <Image
                  src="/image1.jpg" // Replace with the path to your image
              ...
              <div className="flex flex-col md:flex-center gap-6 items-start mb-5">
                ...
                >
                  ...
                  >
                    Senior Secondary Education at Our School
                  </h2>
                  <p className="text-gray-700 mb-4 leading-relaxed">
                    Senior secondary education is a crucial stage in a child's
                    academic journey. It prepares them for higher education and
                    professional paths. Our school offers a robust and dynamic
                    learning environment where students can excel academically
                    and develop personally.
                  </p>

                  <p className="text-gray-700 mb-4 leading-relaxed">
                    At this stage, we emphasize critical thinking, problem-solving,
                    and innovation. Our classrooms are designed to encourage
                    collaboration, and our faculty is highly dedicated to providing
                    guidance and mentorship.
                  </p>

                  <p className="text-gray-700 mb-4 leading-relaxed">
                    Students have access to modern technology, laboratories, and
